...
{  
    ...
    {
        return "SavingsAccount[interestRate=" + this.interestRate + "]" + super.toString();
    }

    public boolean equals(Object obj)
    {
        boolean isEqualInterest = false;
        SavingsAccount acc = (SavingsAccount)obj;
        if (acc.interestRate == this.interestRate) 
            isEqualInterest = true;

        return super.equals(obj) & isEqualInterest;
    }
